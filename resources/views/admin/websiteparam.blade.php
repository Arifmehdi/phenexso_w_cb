...
<div class="container-fluid pt-5">
    <div class="card card-widget">
        ...
        <form action="{{ route('websiteparam.update',$websiteParameter->id) }}" enctype="multipart/form-data"
            method="POST">
            @csrf
                            ...
                            <div class="card-body">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="website_title" class="form-control"
                                        value="{{ old('website_title') ?: $websiteParameter->website_title ?? '' }}"
                                        id="website_title" placeholder="Short Title for Admin Left Sidebar"
                                        autocomplete="off">
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="shipping_cahrge" class="form-control"
                                        value="{{ old('shipping_cahrge') ?: $websiteParameter->shipping_cahrge ?? '' }}"
                                        id="shipping_cahrge" placeholder="Shipping Charge" autocomplete="off">
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <textarea name="google_search_console" class="form-control textarea" rows="7"
                                        id="google_search_console"
                                        placeholder="Job websiteParameter instraction">{{ old('google_search_console') ?: $websiteParameter->google_search_console ?? '' }}</textarea>
                                </div>

                                <div class="form-group ">
                                    <label for="google_analytics_code" class="control-label"> Google Analytics
                                        (Tracking) Code </label>
                                    <textarea name="google_analytics_code" class="form-control" rows="10"
                                        id="google_analytics_code"
                                        placeholder="Google Analytics Code (Tracking Code)">{{ old('google_analytics_code') ?: $websiteParameter->google_analytics_code ?? '' }}</textarea>
                                ...
                                <div class="form-group ">
                                    ...
                                    <textarea name="facebook_pixel_code" class="form-control" rows="10"
                                        id="facebook_pixel_code"
                                        placeholder="Facebook Pixel Code (Tracking Code)">{{ old('facebook_pixel_code') ?: $websiteParameter->facebook_pixel_code ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="meta_author" class="form-control"
                                        value="{{ old('meta_author') ?: $websiteParameter->meta_author ?? '' }}"
                                        id="meta_author" placeholder="Meta Author for SEO of website"
                                        autocomplete="off">
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <textarea name="meta_description" class="form-control" rows="4"
                                        id="meta_description"
                                        placeholder="Meta Description for SEO of Website">{{ old('meta_description') ?: $websiteParameter->meta_description ?? '' }}</textarea>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <textarea name="footer_copyright" class="form-control" rows="4"
                                        id="footer_copyright"
                                        placeholder="Copyright text in footer area">{{ old('footer_copyright') ?: $websiteParameter->footer_copyright ?? '' }}</textarea>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="fb_url" class="form-control"
                                        value="{{ old('fb_url') ?: $websiteParameter->fb_url ?? '' }}" id="fb_url"
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="contact_address" class="form-control"
                                        value="{{ old('contact_address') ?: $websiteParameter->contact_address ?? '' }}"
                                        id="contact_address" placeholder="+address" autocomplete="off">
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="contact_email" class="form-control"
                                        value="{{ old('contact_email') ?: $websiteParameter->contact_email ?? '' }}"
                                        id="contact_email" placeholder="example@.com" autocomplete="off">
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="youtube_url" class="form-control"
                                        value="{{ old('youtube_url') ?: $websiteParameter->youtube_url ?? '' }}"
                                        id="youtube_url" placeholder="Youtube Url" autocomplete="off">
                                </div>
                                <div class="form-group ">
                                    <label for="iframe_map" class="  control-label">Iframe Map</label>
                                    <input type="text" name="iframe_map" class="form-control"
                                        value="{{ old('iframe_map') ?: $websiteParameter->iframe_map ?? '' }}"
                                        id="iframe_map" placeholder="Iframe Map" autocomplete="off">
                                </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="w3-display-container" style="height:110px;">
                                            <img class="img-responsive" style="width: 50px;"
                                                src="{{ route('imagecache', ['template' => 'original', 'filename' => $websiteParameter->favicon()]) }}"
                                                alt="" id="showFavicon">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="w3-display-container" style="max-height:110px;">
                                            <img class="img-responsive" style="max-width: 100%;" src="{{ route('imagecache', ['template' => 'cpmd', 'filename' => $websiteParameter->logo()]) }}"
                    alt="" id="showLogo">
                </div>
            </div>
    </div>
                ...
                <div class="col-sm-4">
                    <div class="w3-display-container" style="height:110px;">
                        <img class="img-responsive" style="max-width: 100%;"
                            src="{{ route('imagecache', ['template' => 'cpmd', 'filename' => $websiteParameter->logo_alt()]) }}"
                            alt="" id="showLogoAlt">
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea name="about_us_en" class="form-control" rows="10" id="about_us_en"
                                placeholder="Write About Us in English">{{ old('about_us_en') ?: $websiteParameter->about_en ?? '' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea name="about_us_bn" class="form-control" rows="10" id="about_us_bn"
                                placeholder="Write About Us in Bangla">{{ old('about_us_bn') ?: $websiteParameter->about_bn ?? '' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <input type="file" name="about_us_image" class="form-control" id="about_us_image"
                                onchange="previewAboutUsImage(event)">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="w3-display-container"
                            style="height:110px; width:100%; border:1px solid #ddd; border-radius:5px; display:flex; align-items:center; justify-content:center; overflow:hidden;">
                            @if($websiteParameter->about_img)
                            <img class="img-responsive about-preview"
                                src="{{ route('imagecache', ['template' => 'cpmd', 'filename' => $websiteParameter->about_img()]) }}"
                                alt="Preview Image" id="showAboutUsImage">
                            @else
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="w3-display-container" style="height:110px;">
                                    <img class="img-responsive" style="width: 50px;"
                                        src="{{ route('imagecache', ['template' => 'original', 'filename' => $websiteParameter->eccomerce_img()]) }}"
                                        alt="" id="showFavicon">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="w3-display-container" style="max-height:110px;">
                                    <img class="img-responsive" style="max-width: 100%;"
                                        src="{{ route('imagecache', ['template' => 'cpmd', 'filename' => $websiteParameter->hospital_img()]) }}"
                                        alt="" id="showLogo">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="w3-display-container" style="height:110px;">
                                    <img class="img-responsive" style="max-width: 100%;"
                                        src="{{ route('imagecache', ['template' => 'cpmd', 'filename' => $websiteParameter->ambulance_img()]) }}"
                                        alt="" id="showLogoAlt">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="w3-display-container" style="height:110px;">
                                    <img class="img-responsive" style="max-width: 100%;"
                                        src="{{ route('imagecache', ['template' => 'cpmd', 'filename' => $websiteParameter->doctor_img()]) }}"
                                        alt="" id="showLogoAlt">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="w3-display-container" style="height:110px;">
                                    <img class="img-responsive" style="max-width: 100%;"
                                        src="{{ route('imagecache', ['template' => 'cpmd', 'filename' => $websiteParameter->diagnostic_img()]) }}"
                                        alt="" id="showLogoAlt">
                                </div>
                            </div>
                        </div>
