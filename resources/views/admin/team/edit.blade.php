...
@section('title')
   Admin Dashboard | Edit Team Member
@endsection
            ...
            <div class="card shadow-sm">
                <div class="card-header px-2 py-2 d-flex justify-content-between align-items-center">
                    <h3 class="card-title w3-small text-bold text-muted pt-1">
                        <i class="fas fa-edit text-primary"></i> Edit Team Member
                    </h3>
                    ...
                    <form action="{{ route('team.update', $team->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control form-control-sm" id="name" placeholder="Enter name" required value="{{ old('name', $team->name) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="designation" class="form-control form-control-sm" id="designation" placeholder="Enter designation" required value="{{ old('designation', $team->designation) }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company" class="form-control form-control-sm" id="company" placeholder="Enter company" value="{{ old('company', $team->company) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="order" class="w3-small">Display Order</label>
                                    <input type="number" name="order" class="form-control form-control-sm" id="order" placeholder="0" value="{{ old('order', $team->order) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">Recommended size: 400x450px. Leave empty to keep current image.</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div id="image-preview" class="border text-center p-1" style="height: 120px; width: 100px; margin: auto;">
                                    <img src="{{ route('imagecache', ['template' => 'original', 'filename' => $team->fiName()]) }}" id="preview" style="max-width: 100%; max-height: 100%;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="status" name="status" {{ $team->status ? 'checked' : '' }}>
