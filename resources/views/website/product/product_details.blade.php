...
@section('title', "Shop Detail - " . env('APP_NAME'))
...
/* Optional: fix image height for related products */
.card-img-top {
    object-fit: cover;
    height: 150px;
}
...
<section class="section my-0 py-0">
    <div class="container py-5">
        ...
        <div class="row g-4">
            <!-- Product Image -->
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm thumb-gallery-thumbs">
            ...
            <div class="col-lg-6">
                ...
                <div class="d-flex justify-content-between">
                    <p class="text-muted small mb-3 w3-small">
                        Category: 
                        <a href="#" class="text-decoration-none">
                            @foreach ($product->categories as $category)
                                <span class="w3-small">{{ $category->name_en }}</span>@if(!$loop->last), @endif
                            @endforeach
                        </a>
                    </p>
                </div>
            ...
            <div class="row g-3">
                @foreach ($relatedProducts as $product)
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="card h-100 border-0 shadow-sm card-hover d-flex flex-column">
                            <!-- Image -->
