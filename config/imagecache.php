...
return [
    ...
    */
    ...
    'paths' => [
        ...
        storage_path('app/public/wp'),
        storage_path('app/public/team'),
        storage_path('app/public/post_images'),
        storage_path('app/public/media_images'),
        storage_path('app/public/media'),
        storage_path('app/public/post_files'),
        storage_path('app/public/frontSlider'),
        storage_path('app/public/galleries'),
        storage_path('app/public/gallery_items'),
        storage_path('app/public/department_images'),
        storage_path('app/public/hospital_images'),
        storage_path('app/public/doctor_images'),
        storage_path('app/public/ambulance_images'),
        storage_path('app/public/product_categories_images'),
